...
def main():
    ...
    i_best = np.argmin(mse_val)  #argmin returns the indices of the lowest mean square error i.e. the best polynomial degree which fits the validation set the best
